...
namespace Store
{
    ...
    public partial class admin : Entity<admin>
    {
        ...
        //    // 处理当前已登录用户信息
        //    if (!Dirtys[__.Username] && ManageProvider.Provider.Current != null) Username = ManageProvider.Provider.Current.Account;
        //}
        ...
        public static admin FindById(Int16 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        //public static EntityList<admin> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
